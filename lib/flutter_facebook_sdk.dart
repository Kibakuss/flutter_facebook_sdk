...
class FlutterFacebookSdk {
  ...
  Future<void> setAdvertiserTracking(
    ...
    await _channel.invokeMethod("setAdvertiserTracking", {
      'enabled': isEnabled,
      'collectId': collectId,
    });
  }
  ...
  Future<bool> setDataProcessingOptions(
      {required List<String> options, int? state, int? country}) async {
    final bool result =
        await _channel.invokeMethod("setDataProcessingOptions", {
      "options": options,
      'state': state,
      'country': country,
    });
  ...
  Future<bool> setAutoLogAppEventsEnabled({required bool isEnabled}) async {
    final bool result =
